...
import { configureLogger, captureConsoleDebug } from '../../src/utils/logger.js';
...
describe('Config Loader', () => {
    ...
    it('should use default values when no env vars or overrides provided', () => {
        ...
        expect(config.defaultSearchEngines).toEqual(['bing', 'duckduckgo', 'brave']);
    ...
    describe('CLI Overrides vs Environment Variables', () => {
        ...
        it('should override debug flag from CLI', async () => {
           ...
           expect(spy).toHaveBeenCalledWith(expect.stringContaining('loader: error detected: Invalid proxy URL'));
